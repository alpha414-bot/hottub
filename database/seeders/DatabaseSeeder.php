...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Product::factory()->create([
            ...
            "about" => "<p>The robust 3.0HP dual-speed pumps power 57 strategically placed jets, delivering a targeted and invigorating massage that melts away stress and tension. The HS8NL Hot Tub is engineered for excellence, featuring a dual filtration system with two efficient filters that maintain impeccable water quality.</p><br/><p>Experience the pinnacle of relaxation with the HS8NL's comprehensive features. The deluxe LED lighting package transforms your spa into a captivating visual, perfect for evening gatherings or a tranquil night alone. The addition of built-in headrests and a soothing waterfall enhances the overall comfort and ambiance of your spa experience.</p><br/><p>One of the standout features of the HS8NL Hot Tub is the extraordinary Crimson Cadence Bluetooth Audio System. Unlike traditional hot tub speakers that are exposed to water and prone to rust, the HS8NL's audio system utilizes transducers mounted on the underside of the shell. These transducers produce phenomenal sound quality without the interference of water, ensuring your favorite tunes sound crisp and clear.</p><br/><p>Every HS8NL Hot Tub comes complete with a cover, providing essential protection and insulation for your spa.</p><br/>",
            "water_care" => "<p>Keep your spa water clear with minimal effort and reduce your environmental footprint.</h4><p>Our dual filtration system, supported by two efficient filters and Ozone technology integration, makes maintaining crystal clear water effortless.</p><p>Harnessing the natural power of Ozone, this eco-friendly technology helps to purify your spa water efficiently, reducing the need for harsh chemical additives.</p><br/><p>Highly efficient and eco-friendly, our Circulation Pump helps keep your spa sanitized by moving the water through the filters without overworking the pumps, all while running with little noise.<p><p>Reducing the running time of your pumps reduces the need for replacements, ultimately lowering the spa's power consumption.</p>",
            "ambiance" => "<p>As the sun sets, let the deluxe LED lighting transform your evenings.</p><p>With twenty surface lights and a master light, your hot tub becomes a stunning visual delight.</p><br/><p>Built-in headrests, a calming water feature, and the amazing Crimson Cadence Bluetooth Audio System enhance your spa experience with comfort and great sound quality.</p>",
            "audio_system" => "<p>Enhance your spa experience with the HS8NL's <strong>Crimson Cadence Bluetooth Audio System.</strong></p><p>Our innovative transducers deliver superior sound without the risk of rust, ensuring your sound is crystal clear and stays in top tier condition. Turn your spa into an entertainment hub for celebrations, or make it your dedicated space for self-care sessions. Simply connect your device via Bluetooth and press play to listen to your favorite playlists, podcasts, or audio books, setting the mood for any occasion.</p>",
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "4 Seats + 1 Lounger",
                    "Hydrotherapy Jets" => 57,
