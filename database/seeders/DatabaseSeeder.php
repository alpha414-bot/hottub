...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Product::factory()->create([
            ...
            "caption" => "Includes Cover and Color-Matching Steps",
            "long_caption" => "Hot tub for up to 6 people",
            "long_description" => "Experience hydrotherapy like never before! Chill out effortlessly in our new cold spa! Designed to revitalize the performance and recovery of champions. Though it boasts a beautifully simplistic design, the GSLB spa isn't for the faint of heart. Are you brave enough to take the plunge?",
            "measurement" => '92" x 92" x 36"',
            "images" => ["1.png"],
            "specifications" => [
                "features" => [
