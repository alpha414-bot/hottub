...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Product::factory()->create([
            ...
            "long_caption" => "3-Pump Hot Tub for up to 6 People",
        ...
        Product::factory()->create([
            ...
            "type" => "full-powered-hot-tubs",
            "caption" => "Includes Cover and Color-Matching Steps",
            "long_caption" => "2-Pump Hot Tub for up to 6 People",
        ...
        Product::factory()->create([
            ...
            "type" => "full-powered-hot-tubs",
            "caption" => "Includes Cover and Color-Matching Steps",
            "long_caption" => "2-Pump Hot Tub for up to 7 People",
        ...
        Product::factory()->create([
            ...
            "long_description" => "When the children have grown up, flown the nest and your life's work is done; the time has come to look after yourself. The ES5DL is perfect when you are looking for something a little more discreet and easier to maintain. The unique, ultra-compact double lounge layout makes facing and talking to one another simple.",
            "measurement" => '85" x 67"',
            "images" => ["2.png", "3.png", "4.png", "5.png", "6.jpg", "7.jpg", "8.jpg", "9.jpg"],
            "features" => [
                ["img" => "hydrotherapy_jets.jpg", "title" => "HYDROTHERAPY JETS", "description" => "Positioned in order to work their magic all over the body, aches and pains simply melt away with $appname invigorating hydrotherapy jets. Neck and shoulder jets target the neck, shoulders and traps while the back jets follow the curvature of the spine to get to the most desired areas. $appname foot blasters give your feet a well-deserved deep tissue massage.",],
                ["img" => "smart_touch_panel.jpg", "title" => "EARTH SMART TOUCH PANEL", "description" => "With it's larger dimension, sleekness and backlit outer rim this touch panel enhances the design of your spa in an instant. It's classy and ergonomic keypad encompassing of a large LCD screen, static colours and 5 keys make it so easy to navigate to your desired outcome."],
                ["img" => "led_laminar_water_feature.jpg", "title" => "LED LAMINAR WATER FEATURE", "description" => "Sit back, relax and let all your troubles trickle away with this LED laminar water feature. Either enjoy on full blast alongside the activated jets or simply switch to tranquillity mode and unwind in peace."],
                ["img" => "designated_step.jpg", "title" => "DESIGNATED STEP", "description" => "All $appname have been designed with a completely flat step on the inside of the spa. Combined with added tread, this feature allows you a much easier and safer passage when entering and exiting your spa."],
                // ["img" => "ergonomic_hybrid_lounger.jpg", "title" => "ERGONOMIC HYBRID LOUNGER", "description" => "This lounger is perfect for users of different heights to stretch out comfortably, plus a subtle foot ridge means anyone can secure their seating position without 'drifting'. Hydrotherapy runs from head to toe, simulating your very own personal masseuse."],
                // ["img" => "deep_blue_sounds.jpg", "title" => "DEEP BLUE SOUNDS", "description" => "Take your hot tub experience to a whole other level with our state of the art Deep Blue Sound system. With integrated Bluetooth, you can create whatever mood you like without having to move! The sound system comes with 2 speakers and a subwoofer for extra bass enabling you to now bring your favourite concerts to you."],
            ],
            "about" => "<h2>Unique, ultra-compact double lounge layout</h2><p>When the children have grown up, flown the nest and your life's work is done; the time has come to look after yourself. The ES5DL is perfect when you are looking for something a little more discreet and easier to maintain.</p><br/><p>The unique, ultra-compact double lounge layout makes facing and talking to one another simple.</p>",
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "3 Seats",
                    "Seating Config" => "1 seat, 2 loungers",
                    "Hydrotherapy Jets" => 31,
                    "Total Jets" => "31",
                    "Special Features" => "31 HYDROTHERAPY JETS<br/>EARTH SMART TOUCH PANEL<br/>LED LAMINAR WATER FEATURE<br/>DESIGNATED STEP<br/>SPECTRA LIGHTS<br/>DEEP BLUE SOUNDS<r/>ERGONOMIC HYBRID LOUNGER<br/>COMPREHENSIVE WARRANTY",
                    "Lights" => "LED perimeter, footwell, fountain & exterior lights",
                    "Controls" => "High quality controls produced by Gecko, Canada",
                    "Music" => "Bluetooth connection with 2 speakers and 1 woofer",
                    "WiFi Module" => "Yes",
                    "Heat Pump Cabinet" => "Yes",
                    "Exterior Lighting Pack" => "Yes",
                    "Water Feature" => "Silent running Laminar Water Feature",
                    "Cup Holder" => "3x backlit holders",
                    "Cabinet" => "Natural grey finish",
                    "Design" => "British",
                    "Colors" => "4 acrylic shell colors, manufactured by Aristech - USA",
                ],
                "technical" => [
                    "Dimensions" => '85" x 67" x 34"',
                    "Pumps" => "1x 3hp pump and 1x circulation pump",
                    "Heater" => "4kW",
                    "Dry Weight" => 635,
                    "Filled Weight" => 2811,
                    "Water Capacity" => 261,
                    "Filtration" => "2 Filters",
                    "Min/Max Power Guide" => "20A/32A @240v 60hZ",
                ]
            ],
            "warranty" => [
                ...
                "Extent of Warranty" => "This warranty extends only to the original consumer purchaser of the spa when invoiced and delivered. The warranty terminates upon any transfer of the ownership, prior to the expiration of the warranty period. Any modifications to the spa will void the warranty.",
            ],
            "free_delivery" => true,
            "free_cover" => true,
            "free_color_matching_step" => true,
        ...
        Product::factory()->create([
            ...
            "short_description" => "Compact dual lounge spa",
            "long_description" => "The ES6DL is the perfect spa for those couples who lead an active lifestyle. Going to the gym, hiking, running, cycling, climbing; all that strain and tension on those muscle groups need to be soothed and the ES6DL has it all. No more debate over who gets to use the lounger first.",
            "measurement" => '79" x 79"',
            "images" => ["1.png", "2.png", "3.png", "4.png", "5.png", "6.jpg", "7.jpg", "8.jpg", "9.jpg", "10.jpg"],
            "features" => [
                ["img" => "hydrotherapy_jets.jpg", "title" => "HYDROTHERAPY JETS", "description" => "Positioned in order to work their magic all over the body, aches and pains simply melt away with $appname invigorating hydrotherapy jets. Neck and shoulder jets target the neck, shoulders and traps while the back jets follow the curvature of the spine to get to the most desired areas. $appname foot blasters give your feet a well-deserved deep tissue massage.",],
                ["img" => "smart_touch_panel.jpg", "title" => "EARTH SMART TOUCH PANEL", "description" => "With it's larger dimension, sleekness and backlit outer rim this touch panel enhances the design of your spa in an instant. It's classy and ergonomic keypad encompassing of a large LCD screen, static colours and 5 keys make it so easy to navigate to your desired outcome."],
                ["img" => "ergonomic_hybrid_lounger.jpg", "title" => "ERGONOMIC HYBRID LOUNGER", "description" => "This lounger is perfect for users of different heights to stretch out comfortably, plus a subtle foot ridge means anyone can secure their seating position without 'drifting'. Hydrotherapy runs from head to toe, simulating your very own personal masseuse."],
            ...
            "about" => "<h2>Perfectly designed to allow couples to unwind and relax together</h2><p>The ES6DL is the perfect spa for those couples who lead an active lifestyle. Going to the gym, hiking, running, cycling, climbing; all that strain and tension on those muscle groups need to be soothed and the ES6DL has it all. No more debate over who gets to use the lounger first.</p><br/><p>The ES6DL features individual foot jets and an embedded, reclined head pillow each so you can both lay back and star gaze at the same time. The ES6DL gives you time back to enjoy one another, turn the jets off, listen to the water gently trickling from the water feature and reminisce of adventures gone by.</p>",
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "4 Seats",
                    "Seating Config" => "2 seats, 2 loungers",
                    "Hydrotherapy Jets" => 31,
                    "Total Jets" => "39",
                    "Special Features" => "39 HYDROTHERAPY JETS<br/>EARTH SMART TOUCH PANEL<br/>LED LAMINAR WATER FEATURE<br/>DESIGNATED STEP<br/>SPECTRA LIGHTS<br/>DEEP BLUE SOUNDS<r/>ERGONOMIC HYBRID LOUNGER<br/>COMPREHENSIVE WARRANTY",
                    "Lights" => "LED perimeter, footwell, fountain, top controls & exterior lights",
                    "Controls" => "High quality controls produced by Gecko, Canada",
                    "Cabinet" => "Natural grey finish",
                    "Design" => "British",
                    "Colors" => "4 acrylic shell colors, manufactured by Aristech - USA",
                    ...
                    "Water Feature" => "Silent running Laminar Water Feature",
                    "Cup Holder" => "3x backlit holders",
                    "Color Options" => "STERLING SILVER<br/>ODYSSEY<br/>ESPRESSO<br/>PEARL SHADOW",
                ],
                "technical" => [
                    "Dimensions" => '79" x 79" x 34"',
                    "Pumps" => "2x 2hp pumps, 1x circulation pump",
                    "Heater" => "4kW",
                    "Dry Weight" => 695,
                    "Filled Weight" => 2870,
                    "Water Capacity" => 261,
                    "Filtration" => "2 Filters",
                    "Min/Max Power Guide" => "20A/42A @240v 60hZ",
        ...
        Product::factory()->create([
            ...
            "long_description" => "This compact single lounge hot tub was the design focal point for the entire $appname range. With its perfectly proportioned compact exterior and spacious seating area the ES6L is a truly versatile spa.",
            "measurement" => '79" x 79"',
            "images" => ["1.jpg", "2.png", "3.png", "4.png", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "9.jpg", "10.jpg", "11.jpg"],
            "features" => [
                ["img" => "hydrotherapy_jets.jpg", "title" => "HYDROTHERAPY JETS", "description" => "Positioned in order to work their magic all over the body, aches and pains simply melt away with $appname invigorating hydrotherapy jets. Neck and shoulder jets target the neck, shoulders and traps while the back jets follow the curvature of the spine to get to the most desired areas. $appname foot blasters give your feet a well-deserved deep tissue massage.",],
                ["img" => "deep_blue_sounds.jpg", "title" => "DEEP BLUE SOUNDS", "description" => "Take your hot tub experience to a whole other level with our state of the art Deep Blue Sound system. With integrated Bluetooth, you can create whatever mood you like without having to move! The sound system comes with 2 speakers and a subwoofer for extra bass enabling you to now bring your favourite concerts to you."],
                ["img" => "smart_touch_panel.jpg", "title" => "EARTH SMART TOUCH PANEL", "description" => "With it's larger dimension, sleekness and backlit outer rim this touch panel enhances the design of your spa in an instant. It's classy and ergonomic keypad encompassing of a large LCD screen, static colours and 5 keys make it so easy to navigate to your desired outcome."],
            ...
            "about" => "<h2>Compact exterior with unrivaled seating space for up to 5 adults</h2><p>This compact single lounge hot tub was the design focal point for the entire $appname range. With its perfectly proportioned compact exterior and spacious seating area the ES6L is a truly versatile spa.</p><br/><p>So if you want to enjoy a quiet night with your partner, invite friends round for a soak and a drink, or splash about with the kids, the ES6L ticks all the boxes.</p>",
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "4-5 Seats",
                    "Seating Config" => "4 seats, 1 lounger",
                    "Hydrotherapy Jets" => 39,
                    "Total Jets" => "39",
                    "Special Features" => "39 HYDROTHERAPY JETS<br/>EARTH SMART TOUCH PANEL<br/>LED LAMINAR WATER FEATURE<br/>DESIGNATED STEP<br/>SPECTRA LIGHTS<br/>DEEP BLUE SOUNDS<r/>ERGONOMIC HYBRID LOUNGER<br/>COMPREHENSIVE WARRANTY",
                    "Lights" => "LED perimeter, footwell, fountain, top controls & exterior lights",
                    "Controls" => "High quality controls produced by Gecko, Canada",
        ...
        Product::factory()->create([
            ...
            "long_description" => "This is what it's all been leading up to, you've put the time to be able to provide somewhere your family call home. Trying to get the family together, trying to get them to put down the iPad and turn off the internet can be a challenge.",
            "measurement" => '85" x 85"',
            "images" => ["1.png", "2.png", "3.png", "4.png", "5.png", "6.jpg", "7.jpg", "8.jpg"],
            "features" => [
                ["img" => "hydrotherapy_jets.jpg", "title" => "HYDROTHERAPY JETS", "description" => "Positioned in order to work their magic all over the body, aches and pains simply melt away with $appname invigorating hydrotherapy jets. Neck and shoulder jets target the neck, shoulders and traps while the back jets follow the curvature of the spine to get to the most desired areas. $appname foot blasters give your feet a well-deserved deep tissue massage.",],
                ["img" => "ergonomic_hybrid_lounger.jpg", "title" => "ERGONOMIC HYBRID LOUNGER", "description" => "This lounger is perfect for users of different heights to stretch out comfortably, plus a subtle foot ridge means anyone can secure their seating position without 'drifting'. Hydrotherapy runs from head to toe, simulating your very own personal masseuse."],
                ["img" => "smart_touch_panel.jpg", "title" => "EARTH SMART TOUCH PANEL", "description" => "With it's larger dimension, sleekness and backlit outer rim this touch panel enhances the design of your spa in an instant. It's classy and ergonomic keypad encompassing of a large LCD screen, static colours and 5 keys make it so easy to navigate to your desired outcome."],
            ...
            "about" => "<h2>Multi level seating space for up to 6 adults</h2><br/><p>This is what it's all been leading up to, you've put the time to be able to provide somewhere your family call home. Trying to get the family together, trying to get them to put down the iPad and turn off the internet can be a challenge.</p><br/><p>The ES7L takes everything back to the core of family life. Being there for one another, talking to one another and creating memories. With the multi level seating that takes you deeper with each position, and a mid-sized versatile lounge, there really is a favorite seat for everyone.</p>",
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "6 Seats",
                    "Seating Config" => "5x seats, 1 lounger",
                    "Hydrotherapy Jets" => 55,
                    "Total Jets" => "55",
                    "Special Features" => "55 HYDROTHERAPY JETS<br/>EARTH SMART TOUCH PANEL<br/>LED LAMINAR WATER FEATURE<br/>DESIGNATED STEP<br/>SPECTRA LIGHTS<br/>DEEP BLUE SOUNDS<r/>ERGONOMIC HYBRID LOUNGER<br/>COMPREHENSIVE WARRANTY",
                    "Lights" => "LED perimeter, footwell, fountain, top controls & exterior lights",
                    "Controls" => "High quality controls produced by Gecko, Canada",
                    "Cabinet" => "Natural grey finish",
                    "Design" => "British",
                    ...
                    "Exterior Lighting Pack" => "Yes",
                    "Water Feature" => "Silent running Laminar Water Feature",
                    "Cup Holder" => "4x backlit holders",
                    "Color Options" => "STERLING SILVER<br/>ODYSSEY<br/>ESPRESSO<br/>PEARL SHADOW",
                ],
                "technical" => [
                    "Dimensions" => '85" x 85" x 36"',
                    "Pumps" => "2x 3hp pumps, 1x circulation pump",
                    "Heater" => "4kW",
                    "Dry Weight" => 769,
                    "Filled Weight" => 3338,
                    "Water Capacity" => 208,
                    "Filtration" => "3 Filters",
                    "Min/Max Power Guide" => "25A/45A @240v 60hZ",
        ...
        Product::factory()->create([
            ...
            "long_description" => "Get the party started and become the ultimate host with ES7NL, our spacious 7 seater hot tub, ideal for bringing family and friends together.",
            "measurement" => '85" x 85"',
            "images" => ["1.png", "2.png", "3.png", "4.png", "5.png", "6.jpg", "7.jpg", "8.jpg", "9.jpg", "10.jpg", "11.jpg", "12.jpg"],
            "features" => [
                ["img" => "ergonomic_hybrid_lounger.jpg", "title" => "ERGONOMIC HYBRID LOUNGER", "description" => "This lounger is perfect for users of different heights to stretch out comfortably, plus a subtle foot ridge means anyone can secure their seating position without 'drifting'. Hydrotherapy runs from head to toe, simulating your very own personal masseuse."],
                ["img" => "designated_step.jpg", "title" => "DESIGNATED STEP", "description" => "All $appname have been designed with a completely flat step on the inside of the spa. Combined with added tread, this feature allows you a much easier and safer passage when entering and exiting your spa."],
                ["img" => "led_laminar_water_feature.jpg", "title" => "LED LAMINAR WATER FEATURE", "description" => "Sit back, relax and let all your troubles trickle away with this LED laminar water feature. Either enjoy on full blast alongside the activated jets or simply switch to tranquillity mode and unwind in peace."],
            ...
            "about" => "<h2>Unrivaled seating space for up to 7 adults</h2><p>Get the party started and become the ultimate host with ES7NL, our spacious 7 seater hot tub, ideal for bringing family and friends together. It's a real crowd pleaser too, with 66 jets and an abundance of special features including an integrated bluetooth sound system, no one is going to want to miss your invite.</p><p>So grab a glass, invite your friends round for a soak and a drink, or have a splash with the kids, ES7NL can more than comfortably handle it all.</p>",
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "7 Seats",
                    "Seating Config" => "7 seats",
                    "Hydrotherapy Jets" => 66,
                    "Total Jets" => "66",
                    "Special Features" => "66 HYDROTHERAPY JETS<br/>EARTH SMART TOUCH PANEL<br/>LED LAMINAR WATER FEATURE<br/>DESIGNATED STEP<br/>SPECTRA LIGHTS<br/>DEEP BLUE SOUNDS<r/>ERGONOMIC HYBRID LOUNGER<br/>COMPREHENSIVE WARRANTY",
                    "Lights" => "LED perimeter, footwell, fountain, top controls & exterior lights",
                    "Controls" => "High quality controls produced by Gecko, Canada",
                    "Cabinet" => "Natural grey finish",
                    "Design" => "British",
        ...
        Product::factory()->create([
            ...
            "long_description" => "The ES8DL re-writes the rule book. Forget having to compromise on size and having to think if the seating will be ideal for other users.",
            "measurement" => '91" x 91"',
            "images" => ["1.png", "2.png", "3.png", "4.png", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "9.jpg", "10.jpg", "11.png", "12.jpg"],
            "features" => [
                ["img" => "designated_step.jpg", "title" => "DESIGNATED STEP", "description" => "All $appname have been designed with a completely flat step on the inside of the spa. Combined with added tread, this feature allows you a much easier and safer passage when entering and exiting your spa."],
                ["img" => "hydrotherapy_jets.jpg", "title" => "HYDROTHERAPY JETS", "description" => "Positioned in order to work their magic all over the body, aches and pains simply melt away with $appname invigorating hydrotherapy jets. Neck and shoulder jets target the neck, shoulders and traps while the back jets follow the curvature of the spine to get to the most desired areas. $appname foot blasters give your feet a well-deserved deep tissue massage.",],
                ["img" => "ergonomic_hybrid_lounger.jpg", "title" => "ERGONOMIC HYBRID LOUNGER", "description" => "This lounger is perfect for users of different heights to stretch out comfortably, plus a subtle foot ridge means anyone can secure their seating position without 'drifting'. Hydrotherapy runs from head to toe, simulating your very own personal masseuse."],
            ...
            "about" => "<h2>Dual multi-jet lounger for up to 5 adults</h2><p>The ES8DL re-writes the rule book. Forget having to compromise on size and having to think if the seating will be ideal for other users. This is the center piece of your garden, the most luxurious and powerful spa in the range, this is your Spa!</p><br/><p>With two equal size large multi-jet loungers, a deep bucket therapy seat, targeted all over body massage, rigorous foot massage, stunningly bright multi-color LED lighting and a double-step tiered entry just to name a few; showmanship has never felt so good.</p>",
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "5 Seats",
                    "Seating Config" => "3x Seats, 2 loungers",
                    "Hydrotherapy Jets" => 76,
                    "Total Jets" => "76",
                    "Special Features" => "76 HYDROTHERAPY JETS<br/>EARTH SMART TOUCH PANEL<br/>LED LAMINAR WATER FEATURE<br/>DESIGNATED STEP<br/>SPECTRA LIGHTS<br/>DEEP BLUE SOUNDS<r/>ERGONOMIC HYBRID LOUNGER<br/>COMPREHENSIVE WARRANTY",
                    "Lights" => "LED perimeter, footwell, fountain, top controls & exterior lights",
                    "Controls" => "High quality controls produced by Gecko, Canada",
                    "Cabinet" => "Natural grey finish",
                    "Design" => "British",
                ...
                "technical" => [
                    ...
                    "Water Capacity" => 396,
                    "Filtration" => "2 Filters",
                    "Min/Max Power Guide" => "25A/50A @240v 60hZ",
        ...
        Product::factory()->create([
            ...
            "long_description" => "The ES8L is a 91″x 91″, 90 jet, 3-pump powerhouse.",
            "measurement" => '91" x 91"',
            "images" => ["1.png", "2.jpg", "3.jpg", "4.jpg", "5.png"],
            "about" => '<h2>Ultimate Powerhouse Spa with Touchscreen</h2><p>The ES8L is a 91"x 91", 90 jet, 3-pump powerhouse. This model boasts no less than 4 foot blasters and 4 well positioned diverters for precision water therapy where you need it most. In addition, the ES8L is the very first spa in our line up to incorporate touchscreen controls with the added comfort of an auxiliary control conveniently located at the back of the spa.</p>',
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "6 Seats",
                    "Seating Config" => "5x Seats, 1 loungers",
                    "Total Jets" => "90",
                    "Lights" => "LED perimeter, footwell, fountain, top controls & exterior lights",
                    "Controls" => "High quality controls produced by Gecko, Canada",
                    "Cabinet" => "Natural grey finish",
                    ...
                    "Music" => "Bluetooth connection with 2 speakers and 1 woofer",
                    "WiFi Module" => "No",
                    "Heat Pump Cabinet" => "No",
                    "Exterior Lighting Pack" => "No",
                    "Water Feature" => "Silent running Laminar Water Feature",
                    "Cup Holder" => "6x backlit holders",
                ],
                "technical" => [
                    "Dimensions" => '91" x 91" x 37"',
                    "Pumps" => "2x 3hp pumps, 1 x 1.5hp, 1x circulation pump",
                    "Heater" => "4kW",
                    "Dry Weight" => 1000,
                    "Filled Weight" => 4100,
                    "Water Capacity" => 370,
        ...
        Product::factory()->create([
            "slug" => "alpha",
            "name" => "GS5L",
            "type" => "generation-hottubs",
            "caption" => "",
            "long_caption" => "Hot tub for up to 3 people",
            "long_description" => "Experience hydrotherapy like never before! Chill out effortlessly in our new cold spa! Designed to revitalize the performance and recovery of champions. Though it boasts a beautifully simplistic design, the GS5L spa isn't for the faint of heart. Are you brave enough to take the plunge?",
            "measurement" => '82" x 66" x 36"',
            "images" => ["1.png"],
            "specifications" => [
                "features" => [
                    ...
                    "Total Jets" => 28,
                    "Pump(s)" => 1,
                    "Standard Feature" => "Balboa Electrical Equipment<br/>Topside Control w/ Digital Display<br/>Graphite or Black Confer Cabinet<br/>Black Weather Shield Cover<br/>Ozone Ready",
                    'LED Light' => '(1) 5" LED Light',
                ],
                "technical" => [
                    "measurement" => '82" x 66" x 36"',
                    "Water Capacity" => 350,
        ...
        Product::factory()->create([
            ...
            "caption" => "",
            "long_caption" => "Hot tub for up to 3 people",
            "long_description" => "Experience hydrotherapy like never before! Chill out effortlessly in our new cold spa! Designed to revitalize the performance and recovery of champions. Though it boasts a beautifully simplistic design, the GS6NL spa isn't for the faint of heart. Are you brave enough to take the plunge?",
            "measurement" => '77" x 77" x 34"',
            "images" => ["1.jpg"],
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "5-6 Person",
                    "Total Jets" => 27,
                    "Pump" => 1,
                    "Standard Feature" => "Balboa Electrical Equipment<br/>Topside Control w/ Digital Display<br/>Graphite or Black Confer Cabinet<br/>Graphite or Black Confer Cabinet<br/>Ozone Ready",
                    'LED Light' => '(1) 5" LED',
                ],
                "technical" => [
                    "measurement" => '77" x 77" x 34"',
        ...
        Product::factory()->create([
            ...
            "type" => "generation-hottubs",
            "caption" => "",
            "long_caption" => "Hot tub for up to 6 people",
            "long_description" => "Experience hydrotherapy like never before! Chill out effortlessly in our new cold spa! Designed to revitalize the performance and recovery of champions. Though it boasts a beautifully simplistic design, the GS7L spa isn't for the faint of heart. Are you brave enough to take the plunge?",
            "measurement" => '82" x 82" x 36"',
            "images" => ["1.png"],
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "5-6 Person",
        ...
        Product::factory()->create([
            ...
            "caption" => "",
            "long_caption" => "Hot tub for up to 6 people",
            "long_description" => "Experience hydrotherapy like never before! Chill out effortlessly in our new cold spa! Designed to revitalize the performance and recovery of champions. Though it boasts a beautifully simplistic design, the GS7NL spa isn't for the faint of heart. Are you brave enough to take the plunge?",
            "measurement" => '82" x 82" x 36"',
            "images" => ["1.png"],
            "specifications" => [
                "features" => [
        ...
        Product::factory()->create([
            ...
            "caption" => "",
            "long_caption" => "Hot tub for up to 6 people",
            "long_description" => "Experience hydrotherapy like never before! Chill out effortlessly in our new cold spa! Designed to revitalize the performance and recovery of champions. Though it boasts a beautifully simplistic design, the GS8L spa isn't for the faint of heart. Are you brave enough to take the plunge?",
            "measurement" => '92" x 92" x 36"',
            "images" => ["1.png"],
            "specifications" => [
                "features" => [
                    "Seating Configuration" => "5-6 Person",
        ...
        Product::factory()->create([
            ...
            "caption" => "",
            "long_caption" => "Hot tub for up to 6 people",
            "long_description" => "Experience hydrotherapy like never before! Chill out effortlessly in our new cold spa! Designed to revitalize the performance and recovery of champions. Though it boasts a beautifully simplistic design, the GS8NL spa isn't for the faint of heart. Are you brave enough to take the plunge?",
            "measurement" => '92" x 92" x 36"',
            "images" => ["1.png"],
            "specifications" => [
                "features" => [
        ...
        Product::factory()->create([
            ...
            "caption" => "",
            "long_caption" => "Hot tub for up to 6 people",
            "long_description" => "Experience hydrotherapy like never before! Chill out effortlessly in our new cold spa! Designed to revitalize the performance and recovery of champions. Though it boasts a beautifully simplistic design, the GS8LB spa isn't for the faint of heart. Are you brave enough to take the plunge?",
            "measurement" => '92" x 92" x 36"',
            "images" => ["1.png"],
            "specifications" => [
                "features" => [
        ...
        Product::factory()->create([
            ...
            "caption" => "Includes Cover and Color-Matching Steps",
            "long_caption" => "Single-Pump Hot Tub for up to 5 People",
        ...
        Product::factory()->create([
            ...
            "type" => "plug-and-play-hot-tubs",
            "caption" => "Includes Cover and Color-Matching Steps",
            "long_caption" => "Single-Pump Hot Tub for up to 3 People",
        ...
        Product::factory()->create([
            ...
            "type" => "cold-spas",
            "caption" => "",
            "long_caption" => "Dual Zone Hot + Cold Plunge Spa",
        ...
        Product::factory()->create([
            ...
            "long_caption" => "Cold Plunge Spa for 1 Person",
